...
public class ContaIntegracaoTest {
	...
	public void buildCliente() {
		...
		ResponseDTO<ContaResponseDTO> response = buildPostRequest(clienteRequest, "digitalbank/api/v1/clientes", HttpStatus.CREATED).
			extract().
				body().
					as(new TypeRef<ResponseDTO<ContaResponseDTO>>() {});
		
		this.contaResponse = response;
	}
	
	@Test
	public void efetuarDepositoTest() {
